...
class Doctor(db.Model    #__tablename__ = 'doctor'
    ...
    #_doctor_specialty = db.relationship('Specialty', secondary=doctor_specialty, 
...
'''class Specialty(db.Model):
	...
	id = db.Column(db.Integer, primary_key=True)
	specialty_name = db.Column(db.Text, nullable=False)'''